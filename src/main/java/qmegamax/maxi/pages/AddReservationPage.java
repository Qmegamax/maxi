    ...
    public AddReservationPage(boolean open) {
        ...
        textField.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (textField.getText().equals("name")) textField.setText("");
            }
        ...
        textArea.addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
                if (textArea.getText().equals("notes")) textArea.setText("");
            }
        ...
        button1.addActionListener(e -> {
            ...
            for (Reservation reservation : GetDataFromDatabase("reservations", Reservation.getEmpty())) {
        ...
        button2.addActionListener(e -> {
            frame.setVisible(false);
            frame.dispose();
            if (open) new PendingReservationsPage();
        });
